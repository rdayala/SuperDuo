...
/**
 * Manages "Authentication" to Scores's backend service, which is required when using a
 *  Adapter even though the app does not require authentication of any user details of any kind.
 *
