...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Account mAccount = FootballSyncAdapter.getSyncAccount(this);
        ContentResolver resolver = getContentResolver();
        resolver.setIsSyncable(mAccount, getString(R.string.content_authority), 1);
        resolver.setSyncAutomatically(mAccount, getString(R.string.content_authority), true);
