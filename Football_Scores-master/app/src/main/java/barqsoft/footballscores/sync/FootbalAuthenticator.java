...
/**
 * Manages "Authentication" to Football score backend service.  The SyncAdapter framework
 ...
 */
public class FootbalAuthenticator extends AbstractAccountAuthenticator {

    public FootbalAuthenticator(Context context) {
        super(context);
    }
